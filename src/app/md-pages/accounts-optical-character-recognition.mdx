...
To see the full code view the github. To grab documents from the companies house API we have a class which exposes a function `get_and_save_latest_accounts(company_number)`. Given a company registration number it gets the pdf of the latest account and saves it, in this case to S3.
