export const meta = {
  ...
  summary: 'How a parent child flow design in Power Automate helped managers and senior leaders gain oversight of high-value supplier transactions, replacing manual checks with a scalable and auditable approval process.',
  period: '2025',
  context: 'Company project',
  readMins: 6,
  impact: [
    'Reduced manual monitoring of high-value supplier transactions.',
    'Improved governance and compliance with a consistent approval trail.',
    'Delivered a scalable, maintainable workflow leveraging Power Automate best practices.'
  ],
  // stack: [Tech.PowerAutomate, Tech.Dataverse, Tech.MicrosoftLists, Tech.Teams]
}
